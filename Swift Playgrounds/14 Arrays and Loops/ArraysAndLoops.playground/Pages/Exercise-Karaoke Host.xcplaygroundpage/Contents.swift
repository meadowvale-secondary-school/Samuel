 ...
 */
var songTitles = ["TEst", "TEst"]
songTitles.append("MF Doom")
songTitles.append("Viktor Vaughn")
songTitles.append("Zev Love X")
 ...
 */
var viktorVaughn = ["Let Me Watch", "Open Mic Nite Pt. 2"]
songTitles += viktorVaughn
