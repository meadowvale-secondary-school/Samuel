 ...
 */
var Samuel = User(name: "Samuel", age: 16, height: 50.3, weight: 45.5, activityLevel: 3)
...
var meterinit = Distance(meters: 50, feet: 50*3.28084)
var feetinit = Distance(meters: 50/3.28084, feet: 50)

/*:
 Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
 */
var mile = Distance(meters: 1600, feet: 1600*3.28084)
print(mile.feet)
