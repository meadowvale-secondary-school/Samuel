...
let favoriteBook = Book(title: "Bruh", author: "I don't care Sr ", pages: 420, price: 69.99)
/*:
...
var heightInInchesInit = Height(heightInInches: 20, heightInCentimeters: 20*2.54)
var heightInCentimetersInit = Height(heightInInches: 30/2.54, heightInCentimeters: 30)
/*:
 ...
 */
var someonesHeight = Height(heightInInches: 65, heightInCentimeters: 65*2.54)
 ...
 */
var myHeight = Height(heightInInches: 5, heightInCentimeters: 5*2.54)
